...
export function QuickActions({ language, t, onLog, onSOS }: any) {
  return (
    <div className="space-y-8">
       <div className="asymmetric-panel bg-white p-6 md:p-10 border-white shadow-2xl shadow-slate-200/40">
       ...
       <button onClick={onLog} className="asymmetric-panel w-full p-6 md:p-10 bg-blue-600 text-white border-none group hover:scale-[1.02] transition-all flex flex-col items-center text-center shadow-2xl shadow-blue-200">
       ...
       <button onClick={onSOS} className="asymmetric-panel w-full p-6 md:p-8 bg-red-50 border-red-100 group flex items-center justify-between transition-all hover:bg-red-500 hover:text-white">
          <div>
